...
import { BankAccountInfoEvent, BankListEvent, BankOpenATMEvent, BankOpenComputerEvent, BillingInvoiceQueryEvent, CashRegisterEvent, CorpOpenInventoryEvent, CorpPositionInfoQueryEvent, InfoScreenViewEvent, LicenseAgencyListEvent, LicenseOpenComputerEvent, LicenseStatusEvent, RoomListUsersEvent, TaxiFeeQueryEvent, TimeOfDayEvent, UserRoleplayStatsChangeEvent } from './messages/incoming/roleplay';
