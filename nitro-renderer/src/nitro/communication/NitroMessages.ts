...
import { PoliceListReportsEvent } from './messages/incoming/roleplay/police/PoliceListReportsEvent';
...
import { CorpListComposer } from './messages/outgoing/roleplay/corp/CorpListComposer';
...
import { GangLeaveComposer } from './messages/outgoing/roleplay/gang/GangLeaveComposer';
...
import { WantedListAddUserComposer } from './messages/outgoing/roleplay/police/WantedListAddUserComposer';
import { WantedListRemoveUserComposer } from './messages/outgoing/roleplay/police/WantedListRemoveUserComposer';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.CORP_POSITION_INFO_QUERY, CorpPositionInfoQueryEvent);
        ...
        this._events.set(IncomingHeader.COMBAT_DELAY_QUERY, CombatDelayEvent);
        this._events.set(IncomingHeader.CASH_REGISTER_QUERY, CashRegisterEvent);
        this._events.set(IncomingHeader.BILLING_INVOICE_QUERY, BillingInvoiceQueryEvent);
        this._events.set(IncomingHeader.TAXI_FEE_QUERY, TaxiFeeQueryEvent);
        this._events.set(IncomingHeader.TAXI_DISPATCHED, TaxiDispatchedEvent);
        this._events.set(IncomingHeader.BANK_ACCOUNT_INFO, BankAccountInfoEvent);
        this._events.set(IncomingHeader.BANK_OPEN_ATM, BankOpenATMEvent);
        this._events.set(IncomingHeader.BANK_LIST, BankListEvent);
        this._events.set(IncomingHeader.BANK_OPEN_COMPUTER, BankOpenComputerEvent);
        this._events.set(IncomingHeader.ROOM_LIST_USERS, RoomListUsersEvent);
        this._events.set(IncomingHeader.INFO_SCREEN_VIEW, InfoScreenViewEvent);
        this._events.set(IncomingHeader.LICENSE_OPEN_COMPUTER, LicenseOpenComputerEvent);
        this._events.set(IncomingHeader.LICENSE_STATUS, LicenseStatusEvent);
        this._events.set(IncomingHeader.LICENSE_AGENCY_LIST, LicenseAgencyListEvent);
        this._events.set(IncomingHeader.CORP_OPEN_INVENTORY, CorpOpenInventoryEvent);
        this._events.set(IncomingHeader.CORP_OPEN_COMPUTER, CorpOpenComputerEvent);
        this._events.set(IncomingHeader.CORP_POSITION_LIST, CorpPositionListEvent);
        this._events.set(IncomingHeader.CORP_EMPLOYEE_LIST, CorpEmployeeListEvent);
        this._events.set(IncomingHeader.CORP_LIST, CorpListEvent);
        this._events.set(IncomingHeader.ROLEPLAY_PERMISSIONS, RoleplayPermissionsEvent);
        this._events.set(IncomingHeader.USERS_ONLINE, UserOnlineCountEvent);
        this._events.set(IncomingHeader.PHONE_OPEN_EVENT, DeviceOpenEvent);
        this._events.set(IncomingHeader.POLICE_LIST_REPORTS, PoliceListReportsEvent);
        this._events.set(IncomingHeader.POLICE_CALL_INFO, PoliceCallInfoEvent);
        this._events.set(IncomingHeader.HOT_BAR_LIST_ITEMS, HotBarListItemsEvent);
        ...
        this._events.set(IncomingHeader.TURF_CONTEXT_MENU_INFO_EVENT, TurfContextMenuInfoEvent);
        this._events.set(IncomingHeader.TURF_CAPTURE_TIME_LEFT_EVENT, TurfCaptureTimeLeftEvent);
        this._events.set(IncomingHeader.WEAPON_ACTION_EVENT, WeaponActionEvent);
    ...
    private registerComposers(): void {
        ...
        // Roleplay
        this._composers.set(OutgoingHeader.CORP_ACCEPT_JOB, CorpAcceptJobComposer);
        ...
        this._composers.set(OutgoingHeader.CORP_STOP_WORK, CorpStopWorkComposer);
        this._composers.set(OutgoingHeader.GANG_DECLINE_INVITE, GangDeclineInviteComposer);
        this._composers.set(OutgoingHeader.GANG_DISBAND, GangDisbandComposer);
        this._composers.set(OutgoingHeader.GANG_INVITE_ACCEPT, GangInviteAcceptComposer);
        ...
        this._composers.set(OutgoingHeader.USER_ROLEPLAY_STATS_QUERY, UserRoleplayStatsQueryComposer);
        this._composers.set(OutgoingHeader.CORP_INFO_QUERY, CorpInfoQueryComposer);
        this._composers.set(OutgoingHeader.CORP_POSITION_INFO_QUERY, CorpPositionInfoQueryComposer);
        this._composers.set(OutgoingHeader.GANG_INFO_QUERY, GangInfoQueryComposer);
        this._composers.set(OutgoingHeader.TIME_OF_DAY_QUERY, TimeOfDayQueryComposer);
        ...
        this._composers.set(OutgoingHeader.EQUIP_WEAPON, EquipWeaponComposer);
        ...
        this._composers.set(OutgoingHeader.BANK_CONNECT_ATM, BankConnectATMComposer);
        this._composers.set(OutgoingHeader.BANK_LIST, BankListComposer);
        this._composers.set(OutgoingHeader.BANK_CONNECT_COMPUTER, BankConnectComputerComposer);
        this._composers.set(OutgoingHeader.ROOM_LIST_USERS, RoomListUsersComposer);
        this._composers.set(OutgoingHeader.INFO_SCREEN_SAVE_COMPOSER, InfoScreenSaveComposer);
        this._composers.set(OutgoingHeader.LICENSE_CONNECT_COMPUTER_COMPOSER, LicenseConnectComputerComposer);
        this._composers.set(OutgoingHeader.LICENSE_STATUS_QUERY_COMPOSER, LicenseStatusQueryComposer);
        this._composers.set(OutgoingHeader.LICENSE_AGENCY_LIST_COMPOSER, LicenseAgencyListComposer);
        this._composers.set(OutgoingHeader.LICENSE_OFFER_COMPOSER, LicenseOfferComposer);
        this._composers.set(OutgoingHeader.CORP_POSITION_LIST_COMPOSER, CorpPositionListComposer);
        this._composers.set(OutgoingHeader.CORP_EMPLOYEE_LIST_COMPOSER, CorpEmployeeListComposer);
        this._composers.set(OutgoingHeader.CORP_EDIT_POSITION_COMPOSER, CorpEditPositionComposer);
        this._composers.set(OutgoingHeader.CORP_DELETE_POSITION_COMPOSER, CorpDeletePositionComposer);
        this._composers.set(OutgoingHeader.CORP_CREATE_POSITION_COMPOSER, CorpCreatePositionComposer);
        this._composers.set(OutgoingHeader.CORP_SUPER_HIRE_COMPOSER, CorpSuperhireComposer);
        this._composers.set(OutgoingHeader.CORP_LIST_COMPOSER, CorpListComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_PERMISSONS_COMPOSER, RoleplayPermissionsComposer);
        this._composers.set(OutgoingHeader.USERS_ONLINE, UserOnlineCountComposer);
        this._composers.set(OutgoingHeader.DEVICE_OPEN, DeviceOpenComposer);
        this._composers.set(OutgoingHeader.DEVICE_CLOSE, DeviceCloseComposer);
        this._composers.set(OutgoingHeader.CALL_POLICE, CallPoliceComposer);
        this._composers.set(OutgoingHeader.POLICE_LIST_REPORTS, PoliceListReportsComposer);
        ...
        this._composers.set(OutgoingHeader.TURF_START_CAPTURE_COMPOSER, TurfStartCaptureComposer);
        this._composers.set(OutgoingHeader.TURF_TIMER_QUERY_COMPOSER, TurfTimerQueryComposer);
        this._composers.set(OutgoingHeader.USER_MOVEMENT_COMPOSER, UserMovementComposer);
        this._composers.set(OutgoingHeader.USER_ATTACK_COMPOSER, UserAttackComposer);
        this._composers.set(OutgoingHeader.WEAPON_RELOAD_COMPOSER, WeaponReloadComposer);
    }
