...
import { BankAccountInfoEvent, BankListEvent, BankOpenATMEvent, BankOpenComputerEvent, BillingInvoiceQueryEvent, CashRegisterEvent, CorpEmployeeListEvent, CorpListEvent, CorpOpenComputerEvent, CorpOpenInventoryEvent, CorpPositionInfoQueryEvent, CorpPositionListEvent, InfoScreenViewEvent, LicenseAgencyListEvent, LicenseOpenComputerEvent, LicenseStatusEvent, DeviceOpenEvent, RoleplayPermissionsEvent, RoomListUsersEvent, TaxiFeeQueryEvent, TimeOfDayEvent, UserOnlineCountEvent, UserRoleplayStatsChangeEvent, PoliceCallInfoEvent, HotBarListItemsEvent } from './messages/incoming/roleplay';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerComposers(): void {
        ...
        this._composers.set(OutgoingHeader.HOTBAR_LIST_ITEMS, HotBarListItemsEvent);
