...
import { BillingInvoiceQueryEvent, CashRegisterEvent, TaxiFeeEvent, TimeOfDayEvent, UserRoleplayStatsChangeEvent } from './messages/incoming/roleplay';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.TAXI_FEE_QUERY, TaxiFeeEvent);
    }
