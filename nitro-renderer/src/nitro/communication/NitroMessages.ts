...
import { CorpPositionInfoQueryEvent } from './messages/incoming/roleplay/corp/CorpPositionInfoQuery';
import { GangInfoQueryEvent } from './messages/incoming/roleplay/gang/GangInfoQueryEvent';
import { GangPositionInfoQueryEvent } from './messages/incoming/roleplay/gang/GangPositionInfoQuery';
...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.GANG_POSITION_INFO_QUERY, GangPositionInfoQueryEvent);
    }
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.GANG_POSITION_INFO_QUERY, GangPositionInfoQueryComposer);
