...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerComposers(): void {
        ...
        this.composers.set(OutgoingHeader.LICENSE_OFFER_COMPOSER, LicenseOfferComposer);
        this.composers.set(OutgoingHeader.CORP_POSITION_LIST_COMPOSER, CorpPositionListComposer);
        this.composers.set(OutgoingHeader.CORP_EMPLOYEE_LIST_COMPOSER, CorpEmployeeListComposer);
        this.composers.set(OutgoingHeader.CORP_EDIT_POSITION_COMPOSER, CorpEditPositionComposer);
        this.composers.set(OutgoingHeader.CORP_DELETE_POSITION_COMPOSER, CorpDeletePositionComposer);
        this.composers.set(OutgoingHeader.CORP_CREATE_POSITION_COMPOSER, CorpCreatePositionComposer);
        this.composers.set(OutgoingHeader.CORP_SUPER_HIRE_COMPOSER, CorpSuperhireComposer);
        this.composers.set(OutgoingHeader.CORP_LIST_COMPOSER, CorpListComposer);
        this.composers.set(OutgoingHeader.ROLEPLAY_PERMISSONS_COMPOSER, RoleplayPermissionsComposer);
        this.composers.set(OutgoingHeader.USERS_ONLINE, UserOnlineCountComposer);
