import { AvatarGuideStatus, IConnection, IRoomCreator, IVector3D, LegacyDataType, NitroConfiguration, ObjectRolling, PetType, RoomObjectType, RoomObjectUserType, RoomObjectVariable, Vector3d } from '../../api';
                ...
                for (const action of status.actions) {
                    ...
                    switch (action.action) {
                        ...
                        case 'mv':
                            ...
                            const weaponSound = new Audio(soundBaseURL.replace('%sample%', 'walking'));

                            weaponSound.volume = 1;
