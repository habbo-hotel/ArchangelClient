import { ColorConverter, GetTicker, IRoomRenderingCanvas, RoomPreviewer, TextureUtils } from '@nitro-rp/renderer';
...
export function LayoutRoomPreviewerView({ roomPreviewer = null, height = 0, children = null }: LayoutRoomPreviewerViewProps) {
